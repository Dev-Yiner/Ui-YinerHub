...
-- 🌈 Hiệu ứng cầu vồng toàn bộ giao diện
task.spawn(function()
    ...
    while task.wait() do
        for i = 0, 255 do
            ...
            -- Cập nhật tất cả giá trị màu trong bảng UI
            for key, value in pairs(getgenv().UIColor) do
                if string.find(string.lower(key), "color") then
                    getgenv().UIColor[key] = color
                end
            end

            -- Cập nhật GUI thực tế
            ...
            if gui then
                for _, obj in ipairs(gui:GetDescendants()) do
                    ...
                    -- Các phần khung, nền, nút, đường viền, highlight...

if getgenv().Crystal then 
	if game.CoreGui:FindFirstChild("Yiner Hub [ Freemium ]") then for i, v in ipairs(game.CoreGui:GetChildren()) do if string.find(v.Name,  "Yiner Hub [ Freemium ]") then v:Destroy() end end end
end
...
local T1UIColor = {
	...
	["Logo Image"] = "rbxassetid://137433805079463",
	["Search Icon Color"] = Color3.fromRGB(255, 255, 255),
	["Search Icon Highlight Color"] = Color3.fromRGB(255, 64, 64),
	["GUI Text Color"] = Color3.fromRGB(245, 250, 255),
	["Text Color"] = Color3.fromRGB(255, 255, 255),
	["Placeholder Text Color"] = Color3.fromRGB(200, 210, 220),
	["Title Text Color"] = Color3.fromRGB(255, 64, 64),
	["Background Main Color"] = Color3.fromRGB(175, 210, 250),
	["Background 1 Color"] = Color3.fromRGB(175, 210, 250),
	["Background 1 Transparency"] = 0,
	["Background 2 Color"] = Color3.fromRGB(195, 225, 250),
	["Background 3 Color"] = Color3.fromRGB(195, 225, 250),
	["Background Image"] = "",
...
local IndexUIColor = {
	["Border Color"] = Color3.fromRGB(145, 185, 245),
	["Click Effect Color"] = Color3.fromRGB(230, 230, 230),
	["Setting Icon Color"] = Color3.fromRGB(230, 230, 230),
	["Logo Image"] = "71582774740545",
	["Search Icon Color"] = Color3.fromRGB(255, 255, 255),
	["Search Icon Highlight Color"] = Color3.fromRGB(145, 185, 245),
	["GUI Text Color"] = Color3.fromRGB(245, 250, 255),
	["Text Color"] = Color3.fromRGB(255, 255, 255),
	["Placeholder Text Color"] = Color3.fromRGB(200, 210, 220),
	["Title Text Color"] = Color3.fromRGB(125, 170, 235),
	["Background Main Color"] = Color3.fromRGB(175, 210, 250),
	["Background 1 Color"] = Color3.fromRGB(175, 210, 250),
	["Background 1 Transparency"] = 0,
	["Background 2 Color"] = Color3.fromRGB(195, 225, 250),
	["Background 3 Color"] = Color3.fromRGB(195, 225, 250),
	["Background Image"] = "",
	["Page Selected Color"] = Color3.fromRGB(145, 185, 245),
	["Section Text Color"] = Color3.fromRGB(125, 170, 235),
	["Section Underline Color"] = Color3.fromRGB(145, 185, 245),
	["Toggle Border Color"] = Color3.fromRGB(145, 185, 245),
	["Toggle Checked Color"] = Color3.fromRGB(255, 255, 255),
	["Toggle Desc Color"] = Color3.fromRGB(185, 185, 185),
	["Button Color"] = Color3.fromRGB(150, 200, 250),
	["Label Color"] = Color3.fromRGB(150, 200, 250),
	["Dropdown Icon Color"] = Color3.fromRGB(230, 230, 230),
	["Dropdown Selected Color"] = Color3.fromRGB(145, 185, 245),
	["Dropdown Selected Check Color"] = Color3.fromRGB(150, 200, 250),
	["Textbox Highlight Color"] = Color3.fromRGB(160,200,255),
	["Box Highlight Color"] = Color3.fromRGB(160,200,255),
	["Slider Line Color"] = Color3.fromRGB(75, 75, 75),
	["Slider Highlight Color"] = Color3.fromRGB(105,145,200),
	["Tween Animation 1 Speed"] = DisableAnimation and 0 or 0.25,
	["Tween Animation 2 Speed"] = DisableAnimation and 0 or 0.5,
	["Tween Animation 3 Speed"] = DisableAnimation and 0 or 0.1,
	["Text Stroke Transparency"] = .5
...
--[[ RAINBOW EFFECT DISABLED: START
-- 🌈 Hiệu ứng cầu vồng toàn giao diện (full tab + viền + nền xanh nhạt)
task.spawn(function()
    local RunService = game:GetService("RunService")
    local CoreGui = game:GetService("CoreGui")

    -- chờ GUI chính load xong
    local gui
    repeat
        gui = CoreGui:FindFirstChild("Yiner Hub [ Freemium ]")
        task.wait(0.1)
    until gui

    -- chạy hiệu ứng cầu vồng liên tục
    while true do
        for i = 0, 255 do
            local hue = (i / 255 + 0.55) % 1 -- bắt đầu từ xanh nhạt
            local color = Color3.fromHSV(hue, 0.8, 1)
            local softText = Color3.fromHSV((hue + 0.5) % 1, 0.3, 1)

            -- cập nhật bảng màu
            for key, _ in pairs(getgenv().UIColor) do
                if string.find(string.lower(key), "color") then
                    getgenv().UIColor[key] = color
                end
            end
            getgenv().UIColor["Text Color"] = softText
            ...
            if gui then
                for _, obj in ipairs(gui:GetDescendants()) do
                    ...
                    if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
                        obj.TextColor3 = softText
                    end

                    -- nền chính và tab
                    if obj:IsA("Frame") or obj:IsA("ImageLabel") or obj:IsA("ImageButton") then
                        if obj.Name == "Main" or obj.Name == "PageContainer" or obj.Name == "SectionFrame" then
                            obj.BackgroundColor3 = color
                        end
                        -- underline + viền
                        if string.find(string.lower(obj.Name), "line") or string.find(string.lower(obj.Name), "border") then
                            obj.BackgroundColor3 = color
                        end
                        -- icon
...
Library_Function.Gui.Name = 'Yiner Hub [ Freemium ]'
...
Library.ToggleUI = function()
	...
	if game.CoreGui:FindFirstChild("Yiner Hub [ Freemium ]")then for a,b in ipairs(game.CoreGui:GetChildren())do if b.Name=="Yiner Hub [ Freemium ]"then b.Enabled= getgenv().UIToggled end end end
end
...
local libCreateNoti = function(Setting)
	...
	TextLabelNoti.Text = "<font color=\"rgb(" .. color .. ")\">Yiner Hub [ Freemium ]</font> "..getgenv().TitleNameNoti
...
function Library.CreateMain(Setting)
	...
	local colorB = tostring(Library_Function.Getcolor(getgenv().UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
	TextLabelMain.Text = "<font color=\"rgb("..color..")\">Yiner Hub [ Freemium ]</font> " .. getgenv().MainDesc
